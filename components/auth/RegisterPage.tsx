    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Попробуйте Pro тариф <span className="font-bold">бесплатно 14 дней</span>
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleRegister}>
             <div>
              <label htmlFor="company" className="block text-sm font-medium text-gray-700">Название компании / Сайт</label>
              <div className="mt-1">
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email (рабочий)</label>
              <div className="mt-1">
